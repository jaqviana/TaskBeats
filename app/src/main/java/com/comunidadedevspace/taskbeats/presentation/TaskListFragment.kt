...
class TaskListFragment : Fragment() {
    ...
    //viewmodel q vai trazer a lista de tarefas. para criar o viewmodel estamos precisando passar um aplication
    ...
    //significa que a view foi criada
   ...
   //so vai abrir a proxima activity
